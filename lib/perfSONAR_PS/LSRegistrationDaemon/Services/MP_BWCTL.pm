package perfSONAR_PS::LSRegistrationDaemon::Services::MP_BWCTL;

=head1 NAME

perfSONAR_PS::LSRegistrationDaemon::Services::MP_BWCTL - This class provides checks for
...
sub type {
    ...
    return "BWCTL Measurement Point";
}
